  ...
  methods: {
    ...
    create() {
      ...
      this.$api
        .post("/blog", form)
        .then((res) => {
          this.msg = "Berhasil membuat post ..";
    ...
    update() {
      ...
      this.$api
        ...
        .then((res) => {
          this.msg = "Berhasil mengupdate post ..";
          this.classAlert = "success";
    ...
    deletePost(id, index) {
      this.$api
        .delete("/blog/" + id)
        .then(() => {
          this.msg = "Post berhasil dihapus..";
